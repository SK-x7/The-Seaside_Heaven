...
function DeleteReservation({ bookingId,handleDelete }) {
  ...
  return (
    <button
      ...
      className="group flex justify-center md:justify-start items-center gap-2 uppercase text-xs font-bold text-primary-300 flex-grow px-3 hover:bg-accent-600 transition-colors hover:text-primary-900"
    >
